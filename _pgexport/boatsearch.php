...
<div id="main-content" class="main-content"> 
    <div id="primary" class="content-area"> 
        <div id="content" class="site-content" role="main"> 
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>> 
                ...
                <div class="entry-content">
                    <section class="container-fluid boat_form" style="width:1080px;">
                        <form class="genericForm" method="post" action=""> 
        ...
        <input type="text" name="makeModel" id="makeModel" value="" />
        See notes below
    -->                             
                            <br> 
                            ...
                            <input type="text" name="lengthFrom" id="lengthFrom" value=""> 
                            <br> 
                            <label for="lengthTo">Length to:</label>                             
                            <input type="text" name="lengthTo" id="lengthTo" value=""> 
                            <br> 
