                ...
                <div class="entry-content">
                    ...
                    <form class="genericForm" method="post" action="<?php echo($_SERVER["REQUEST_URI"]);?>">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-4 form-group" data-pg-name="Boat type">
                                ...
                                <div class="col-md-4 form-group" data-pg-name="Make">
							...
							?>
                                ...
                                <div class="col-md-4 form-group" data-pg-name="Location">
