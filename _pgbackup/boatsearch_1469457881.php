            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>> 
                ...
                <div class="entry-content">
                    ...
                    <form class="genericForm" method="post" action="<?php echo($_SERVER["REQUEST_URI"]);?>">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-4 pull-right" data-pg-name="For sale / charter">
                                    <label for="saleCharter">For sale / charter:</label>
                                    <select name="saleCharter" id="saleCharter" class="input-lg">
                                ...
                                <div class="col-md-4" data-pg-name="New / used">
                                    ...
                                    <select name="newUsed" id="newUsed" class="input-lg">
                                        <option value="">Any</option>
                                ...
                                <div class="col-md-4" data-pg-name="Sail / power / commercial">
                                    ...
                                    <select name="sailPower" id="sailPower" class="input-lg">
                                        <option value="">Any</option>
