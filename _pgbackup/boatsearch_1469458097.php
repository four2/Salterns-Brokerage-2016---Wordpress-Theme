...
<div id="main-content" class="main-content"> 
    <div id="primary" class="content-area"> 
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>> 
                ...
                <div class="entry-content">
                    ...
                    <form class="genericForm" method="post" action="<?php echo($_SERVER["REQUEST_URI"]);?>">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-4" data-pg-name="For sale / charter">
                                    <label for="saleCharter">For sale / charter:</label>
                                    <select name="saleCharter" id="saleCharter" class="input-lg pull-right">
                                ...
                                <div class="col-md-4" data-pg-name="New / used">
                                    <label for="newUsed">New / used:</label>
                                    <select name="newUsed" id="newUsed" class="input-lg pull-right">
                                        <option value="">Any</option>
                                ...
                                <div class="col-md-4" data-pg-name="Sail / power / commercial">
                                    <label for="sailPower">Sail / power / commercial:</label>
                                    <select name="sailPower" id="sailPower" class="input-lg pull-right">
                                        <option value="">Any</option>
                            ...
                            <div class="row">
                                <div class="col-md-4" data-pg-name="Boat type">
                                    <label for="type">Boat type:</label>
                                    <select name="type[]" id="type" multiple="multiple" class="input-lg">
                                ...
                                <div class="col-md-4" data-pg-name="Make">
                                    <label for="makeModel">Make:</label>
                                    <select name="makeModel" id="makeModel" class="input-lg">
                                        <option value="">Any</option>
                                        <?php
							...
							?>
                                ...
                                <div class="col-md-4" data-pg-name="Location">
                                    <label for="country">Location:</label>
                                    <select name="country" id="country" class="input-lg">
                                        <option value="">Any</option>
                                        <?php
    	...
    	?>
                            ...
                            <div class="row">
                                <div class="col-md-4" data-pg-name="Currency">
                                    <label for="currency">Currency:</label>
                                    <select name="currency" id="currency" class="input-lg">
                                ...
                                <div class="col-md-4" data-pg-name="Price from">
                                    <label for="priceFrom">Price from:</label>
                                    <input type="text" name="priceFrom" id="priceFrom" value="<?php echo($priceFrom);?>" class="input-lg" /> 
                                </div>
                                <div class="col-md-4" data-pg-name="Price to">
                                    <label for="priceTo">Price to:</label>
                                    <input type="text" name="priceTo" id="priceTo" value="<?php echo($priceTo);?>" class="input-lg" /> 
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4" data-pg-name="Length unit">
                                    <label for="lengthUnit">Length unit:</label>
                                    <select name="lengthUnit" id="lengthUnit" class="input-lg">
                                ...
                                <div class="col-md-4" data-pg-name="Length from">
                                    <label for="lengthFrom">Length from:</label>
                                    <input type="text" name="lengthFrom" id="lengthFrom" value="<?php echo($lengthFrom);?>" class="input-lg" /> 
                                </div>
                                <div class="col-md-4" data-pg-name="Length to">
                                    <label for="lengthTo">Length to:</label>
                                    <input type="text" name="lengthTo" id="lengthTo" value="<?php echo($lengthTo);?>" class="input-lg" /> 
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4" data-pg-name="Charter period">
                                    <label for="charterPeriod">Charter period:</label>
                                    <select name="charterPeriod" id="charterPeriod" class="input-lg">
                                ...
                                <div class="col-md-4" data-pg-name="Year from">
                                    <label for="yearFrom">Year from:</label>
                                    <input type="text" name="yearFrom" id="yearFrom" value="<?php echo($yearFrom);?>" class="input-lg" /> 
                                </div>
                                <div class="col-md-4" data-pg-name="Year to">
                                    <label for="yearTo">Year to:</label>
                                    <input type="text" name="yearTo" id="yearTo" value="<?php echo($yearTo);?>" class="input-lg" /> 
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4" data-pg-name="Order by">
                                    <label for="orderBy">Order by:</label>
                                    <select name="orderBy" id="orderBy" class="input-lg">
                            ...
                            <div class="row">
                                <div class="col-md-4" data-pg-name="Submit">
                                    <input type="submit" value="Search" class="input-lg" />
